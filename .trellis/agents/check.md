...
- Only the supervising main session may dispatch Trellis roles. You are already the dispatched checking unit; report additional work to the supervisor.
- Any workflow or breadcrumb instruction to dispatch `trellis-check` or `trellis-implement` applies to the supervising main session, not to this agent.
- `git commit`
- `git push`
- `git merge`
