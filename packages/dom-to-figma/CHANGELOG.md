...
- [`bf0bf8e`](https://github.com/figitdesign/web-to-figma/commit/bf0bf8edd5a84db2072cb2843698d7b8ee6f959e) Thanks [@aakkino](https://github.com/aakkino)! - Improve CSS border, gradient, shadow, filter, blur, outline, and fractional frame rendering parity while preserving fork-specific traversal, text sizing, font, and image behavior.
